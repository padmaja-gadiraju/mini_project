...
if(isset($_POST['insert']))
{
    ...
    $query = "INSERT INTO `agriculture`(`id`, `name`, `crop`, `quantity`, `prev_bid_price`, `pres_bid_price`, `contact`, `village`, `mandal`) VALUES ('$id','$name','$crop','$quantity','$prev_bid_price','$pres_bid_price','$contact','$village','$mandal')";

...
if(isset($_POST['update']))
{
    ...
    $query = "UPDATE agriculture SET id ='$id',name='$name',crop='$crop',quantity='$quantity',prev_bid_price='$prev_bid_price',pres_bid_price='$pres_bid_price',contact='$contact',village='$village',mandal='$mandal' where id='$id' ";

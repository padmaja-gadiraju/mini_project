...
<body>
    ...
    <div class="container" align='center'>
        ...
        <p align = 'CENTER'>
        <button type="submit" style="color:black;"><a href="insert.php"> INSERT</a></button>
        </p>
        ...
        <table align='center' >
                ...
                if(isset($_POST['search']))
                {
                    ...
                    $sql = "SELECT * FROM agriculture WHERE crop ='$crop' AND mandal='$mandal' AND contact = '$contact'";
